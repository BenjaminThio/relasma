...
static void __pyx_f_11test_module_main(void); /*proto*/
...
#define __pyx_kp_u_Hello_Mum __pyx_string_tab[1]
...
#define __pyx_n_u_print __pyx_string_tab[6]
...
static void __pyx_f_11test_module_main(void) {
...
*/
    ...
    __pyx_t_4 = 1;
    {
      PyObject *__pyx_callargs[2] = {__pyx_t_3, __pyx_mstate_global->__pyx_kp_u_Hello_Mum};
...
*/
  ...
  __Pyx_AddTraceback("test_module.main", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}
 ...
 * main()             # <<<<<<<<<<<<<<
*/
  __pyx_f_11test_module_main(); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L1_error)
...
static int __Pyx_InitCachedBuiltins(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  __pyx_builtin_print = __Pyx_GetBuiltinName(__pyx_mstate->__pyx_n_u_print); if (!__pyx_builtin_print) __PYX_ERR(0, 4, __pyx_L1_error)
  return 0;
  __pyx_L1_error:;
  return -1;
}
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{10},{18},{8},{10},{8},{5},{12},{10},{8}};
const char* const bytes = "?Hello Mum!cline_in_traceback__main____module____name__print__qualname__setdefault__test__";
    PyObject *data = NULL;
